...
/* @var $faculty array|\backend\models\Faculty|null|\yii\db\ActiveRecord */
/* @var $menus array|\backend\modules\menumanager\models\Menu|null|\yii\db\ActiveRecord */
$this->title=$faculty['title_'.Yii::$app->language] ;
?>
<header class="header_section">
    <h1 class="title" style="max-width: 500px;text-align: center;color: white!important;"><?=$faculty['title_'.Yii::$app->language]?></h1>
    <div class="map_site">
        <a href="<?=\yii\helpers\Url::to(['site/index'])?>" class="main_page_link"><?=Yii::t("app","Home")?></a>
        <p class="this_page" style="max-width: 540px"> <i class="fas fa-angle-double-right"></i><?=$faculty['title_'.Yii::$app->language]?></p>
    </div>
</header>
<section class="page-content pb-5">
    <div class="page-content-section py-4">
        <div class="container ">
            <div class="row">
                <div class="col-lg-8">
                    <h2 style="text-align: center;color: #000064"><?=$faculty['title_'.Yii::$app->language]?></h2><br>
                    <?=$faculty['content_'.Yii::$app->language]?>
                </div>
                <div class="col-lg-4 sidebar">
                    <ul class="main-menu__list">
                        <li style="background: red!important;"><a href="#"><?=$menus['title_'.Yii::$app->language]?></a></li>
                ...
                <div class="info_block_persons ">
                    <div class="info_block_person">
                        <div class="photo_person col-md-3 col-sm-3" style="border: none !important; width: 230px !important; height: 230px !important;" >
                            <img class="photo_person_img" src="<?=$leader['rasm']?>" alt="person" style="object-fit:cover !important;width: 100% !important;height: 100% !important;object-position: center !important;  ">
                        </div>

    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-4">
            <?= $form->field($node, 'url_type')->dropDownList([
                ...
                'main' => "Bosh sahifa",
                'documents' => "Hujjat turi",
                'faculty' => "Fakultetler",
                'departments'=>'Kafedralar',
                'category' => "Maqola kategoriyalari",
                'leader'=>'Rahbariyat',
                'page' => "Sahifalar",
                ...
                'other' => "Boshqa",
                   ...
                   var t =  $(this).val()
                    ...
                    else if (t === "category" || t === "leader" || t === "departments" ||  t === "page"|| t === "documents" || t === "faculty"|| t == "catalog" || t == "sub_catalog" || t == "c-action"){
                        $.ajax({
                            url: menu_url,
                            data: {type:t},
                            type: "get",
            ...
            <div class="form-group highlight-addon field-tree-url_value">
                ...
                <div id="menu-value">
                    ...
                    if ($node->url_type == 'category')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(\backend\models\Post::find()->all(), 'slug', 'title_uz' ))->label(false);
                    elseif($node->url_type == 'page')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(\backend\models\Page::find()->all(), 'identifikator', 'slug' ))->label(false);
                    elseif($node->url_type == 'documents')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(\backend\models\Documents::find()->all(), 'slug', 'title_uz' ))->label(false);
                    elseif($node->url_type == 'leader')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(\backend\models\Leadercategory::find()->all(), 'slug', 'title_uz' ))->label(false);
                    elseif($node->url_type == 'faculty')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(\backend\models\Faculty::find()->all(), 'slug', 'title_uz' ))->label(false);
                    elseif($node->url_type == 'departments')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(\backend\models\Departments::find()->all(), 'slug', 'title_uz' ))->label(false);

...
?>
                    <div class="post-index">
                        <p>
                            <? $this->params['create']=Html::a('<span class="glyphicon glyphicon-plus btn btn-success" ></span>',['post/create'],['style'=>'margin-right:10px']) ?>
                        </p>
                        ...
                        <?= GridView::widget([
                            ...
                            'columns' => [
                                [
                                    ...
                                    'contentOptions'=>function(\backend\models\Post $model){
                                        $class='';
                                        switch ($model->status)
                                        {
                                            case \backend\models\Post::STATUS_SHOWED:$class='alert-success';break;
                                            case \backend\models\Post::STATUS_NOTSHOWED:$class='alert-danger';break;
                                ...
                                [
                                    ...
                                    'label'=>'status',
                                    'value'=>function(\backend\models\Post $model){
                                        return \backend\models\Post::getstatus()[$model->status];
                                    },
                                    'filter'=>\backend\models\Post::getstatus(),
                                ],

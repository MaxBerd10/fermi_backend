...
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
        <li class="active"><a href="#tab_1" data-toggle="tab" aria-expanded="true">Rahbariyat qabuliga yozilish</a></li>
        <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false">Rektor qabuliga yozilish</a></li>
    </ul>
                ...
                'columns' => [
                    ...
                    ['class' => 'yii\grid\ActionColumn','template'=>'{view}  {delete} {mark}',
                        'buttons'=>[
                            ...
                            {
                                if ($model->status==1){
                                    return Html::a('<span class="glyphicon glyphicon-ok btn btn-success"></span>',['acceptance/mark', 'id'=>$model->id]);
                                }
                                else
                                {
                                    return Html::a('<span class="glyphicon glyphicon-ok btn btn-danger"></span>', ['acceptance/mark', 'id'=>$model->id]);
                                }
                            },
                            'view'=>function($url,$model,$key){
                                return Html::a('<span class="glyphicon glyphicon-eye-open btn btn-info"></span>',['acceptance/view', 'id'=>$model->id]);
                            },
                            'delete'=>function($url,$model,$key){
                                return Html::a('<span class="glyphicon glyphicon-trash btn btn-danger"></span>',['acceptance/index', 'id'=>$model->id], ['data-method'=>"POST"]);
                            }
                        ],

...
$this->title = 'Yangiliklar turi';
$this->params['breadcrumbs'][] = $this->title;
?>
                        <div class="postcategory-index">

                            <p>
                                <?$this->params['create']=Html::a('<span class="glyphicon glyphicon-plus btn btn-success"></span>',['postcategory/create']);?>
                            </p>
                            ...
                            <?= GridView::widget([
                                ...
                                'columns' => [
                                    [
                                        ...
                                        'contentOptions'=>function(\backend\models\Postcategory $model){
                                            $class='';
                                            switch ($model->status)
                                            {
                                                case \backend\models\Postcategory::STATUS_SHOWED:$class='alert-success';break;
                                                case \backend\models\Postcategory::STATUS_NOTSHOWED:$class='alert-danger';break;

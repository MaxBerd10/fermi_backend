...
<div class="documentsitem-form">
    ...
    <?= $form->field($model, 'document_id')->dropDownList(\yii\helpers\ArrayHelper::map(\backend\models\Documents::find()->all(),'id','title_uz'),['prompt'=>'select..']) ?>

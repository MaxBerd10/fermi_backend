 ...
 * @property int $status
 *
 * @property DocumentsItem[] $documentsItems
 */
class Documents extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['title_uz', 'title_ru', 'title_en', 'slug', 'status'], 'required'],
            [['status'], 'integer'],
    ...
    /**
     * Gets query for [[DocumentsItems]].
     *
     * @return \yii\db\ActiveQuery
     */
    public function getDocumentsItems()
    {
        return $this->hasMany(DocumentsItem::className(), ['document_id' => 'id']);
    }
